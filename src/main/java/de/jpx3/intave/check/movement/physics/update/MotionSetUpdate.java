...
public final class MotionSetUpdate extends TickAmbiguousUpdate {
	private final Motion motion;
	private CausalConstraint causalConstraint;

	private MotionSetUpdate(Motion motion, CausalConstraint causalConstraint) {
		this.motion = motion;
	...
	public boolean equals(Object obj) {
		if (obj instanceof MotionSetUpdate) {
			MotionSetUpdate other = (MotionSetUpdate) obj;
	...
	public String toString() {
		return "MotionSetUpdate{motion=" + motion + ", at="+causalConstraint+"}";
	}

	public static MotionSetUpdate openEnded(
		Motion motion, MovementMetadata metadata
	) {
		long sequenceNumber = metadata.newSequenceNumber();
		return new MotionSetUpdate(
			motion.copy(),
